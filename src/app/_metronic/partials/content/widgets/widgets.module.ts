...
import { ConventionHallBodyWidgetComponent } from './convention-hall/convention-hall-body-widget/convention-hall-body-widget.component';
import { ConventionHallFeatureWidgetComponent } from './convention-hall/convention-hall-feature-widget/convention-hall-feature-widget.component';
import { ConventionHallHeaderWidgetComponent } from './convention-hall/convention-hall-header-widget/convention-hall-header-widget.component';
import { ConventionHallImageGalleryWidgetComponent } from './convention-hall/convention-hall-image-gallery-widget/convention-hall-image-gallery-widget.component';
import { ConventionHallSpecialFeatureWidgetComponent } from './convention-hall/convention-hall-special-feature-widget/convention-hall-special-feature-widget.component';
import { DeluxeRoomBodyWidgetComponent } from './deluxe-room/deluxe-room-body-widget/deluxe-room-body-widget.component';
import { DeluxeRoomHeaderWidgetComponent } from './deluxe-room/deluxe-room-header-widget/deluxe-room-header-widget.component';
import { DeluxeRoomImageGalleryWidgetComponent } from './deluxe-room/deluxe-room-image-gallery-widget/deluxe-room-image-gallery-widget.component';
import { DeluxeRoomSpecialFeatureWidgetComponent } from './deluxe-room/deluxe-room-special-feature-widget/deluxe-room-special-feature-widget.component';
import { FamilySuiteBodyWidgetComponent } from './family-suite/family-suite-body-widget/family-suite-body-widget.component';
import { FamilySuiteHeaderWidgetComponent } from './family-suite/family-suite-header-widget/family-suite-header-widget.component';
import { FamilySuiteSpecialFeatureWidgetComponent } from './family-suite/family-suite-special-feature-widget/family-suite-special-feature-widget.component';
import { ConventionHallWidgetComponent } from './reservation/convention-hall-widget/convention-hall-widget.component';
import { DeluxeRoomWidgetComponent } from './reservation/deluxe-room-widget/deluxe-room-widget.component';
import { FamilySuiteWidgetComponent } from './reservation/family-suite-widget/family-suite-widget.component';
import { VipSuiteWidgetComponent } from './reservation/vip-suite-widget/vip-suite-widget.component';
import { VipSuiteBodyWidgetComponent } from './vip-suite/vip-suite-body-widget/vip-suite-body-widget.component';
import { VipSuiteHeaderWidgetComponent } from './vip-suite/vip-suite-header-widget/vip-suite-header-widget.component';
...
@NgModule({
  declarations: [
    ...
    ConventionHallWidgetComponent,
    VipSuiteWidgetComponent,
    FamilySuiteWidgetComponent,
    DeluxeRoomWidgetComponent,
    ConventionHallHeaderWidgetComponent,
    ConventionHallSpecialFeatureWidgetComponent,
    ConventionHallBodyWidgetComponent,
    ConventionHallImageGalleryWidgetComponent,
    ConventionHallFeatureWidgetComponent,
    DeluxeRoomHeaderWidgetComponent,
    DeluxeRoomBodyWidgetComponent,
    DeluxeRoomSpecialFeatureWidgetComponent,
    DeluxeRoomImageGalleryWidgetComponent,
    VipSuiteHeaderWidgetComponent,
    VipSuiteBodyWidgetComponent,
    FamilySuiteHeaderWidgetComponent,
    FamilySuiteBodyWidgetComponent,
    FamilySuiteSpecialFeatureWidgetComponent,
  ],
  imports: [
    CommonModule,
    DropdownMenusModule,
