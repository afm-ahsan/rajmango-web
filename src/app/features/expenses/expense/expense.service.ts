...
export class ExpenseService {
  ...
  // Show lists of item
  list(): Observable<any> {
    return this.httpClient.get(`${this.apiUrl}/expense`).pipe(
  ...
  getItem(id: any): Observable<any> {
    return this.httpClient.get(`${this.apiUrl}/expense/${id}`).pipe(
      catchError(this.handleError)
    );
  }

  //'https://localhost:7213/api/expense-information/paged?pageNumber=1&pageSize=10'
  getAll(pagedAndSortedDto: PagedAndSortedDto): Observable<any> {
    ...
    return this.httpClient.get(`${this.apiUrl}/expense/paged`, {params}).pipe(
      catchError(this.handleError)
    );
  }
  ...
  //   params = params.set('filter', pagedAndSortedDto.filter);
  //   return this.httpClient.get(`${this.apiUrl}/expense-information/GetPagedAndSortedResult`, {params}).pipe(
  //     catchError(this.handleError)
  //   );
  // }

  create(data: any): Observable<any> {
    return this.httpClient.post(`${this.apiUrl}/expense`, data).pipe(
      catchError(this.handleError)
    );
  }
  ...
  update(id: any, data: any): Observable<any> {
    return this.httpClient.put(`${this.apiUrl}/expense/${id}`, data).pipe(
      catchError(this.handleError)
    );
  }
  ...
  delete(id: any): Observable<any> {
    return this.httpClient.delete(`${this.apiUrl}/expense/${id}`).pipe(
      catchError(this.handleError)
    );
  }
