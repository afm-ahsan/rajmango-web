...
const API_USERS_URL = `${environment_demo.apiUrl}/users`;
// const apiUrl = 'https://localhost:7189'
const apiUrl = 'https://localhost:44315'
const API_WEATHER_FORCAST_URL = `${apiUrl}/api`;
...
export class AuthFakeHTTPService {
  ...
  getWeatherForecast(): Observable<any> {
    return this.http.get<any>(`${API_WEATHER_FORCAST_URL}/weather-forecast`);
  }
}
